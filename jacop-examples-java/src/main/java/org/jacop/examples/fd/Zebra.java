 ...
 *
 * <p>It was given at The German Institute of Logical Thinking in Berlin, 1981. And 98% FAILED.
 *
 * <p>Conditions
 *
 * <p>1. The Englishman lives in the red house. 2. The Spaniard owns a dog. 3. The Japanese is a
 * painter. 4. The Italian drinks tea. 5. The Norwegian lives in the first house on the left. 6. The
 * owner of the green house drinks coffee. 7. The green house is on the right of the white one. 8.
 * The sculptor breeds snails. 9. The diplomat lives in the yellow house. 10. Milk is drunk in the
 * middle house. 11. The Norwegian's house is next to the blue one. 12. The violinist drinks fruit
 * juice. 13. The fox is in a house next to that of the doctor. 14. The horse is in a house next to
 * that of the diplomat. Q. Who owns a Zebra, and who drinks water?
 *
...
public class Zebra extends ExampleFd {
  ...
  public void model() {
    ...
    final int ienglish = 0;
    final int ispaniard = 1;
    final int ijapanese = 2;
    final int iitalian = 3;
    final int inorwegian = 4;

    String[] petNames = {"dog", "snails", "fox", "horse", "zebra"};
    final int idog = 0;
    final int isnails = 1;
    final int ifox = 2;
    final int ihorse = 3; /*, izebra = 4 */
    String[] professionNames = {"painter", "sculptor", "diplomat", "violinist", "doctor"};
    final int ipainter = 0;
    final int isculptor = 1;
    final int idiplomat = 2;
    final int iviolinist = 3;
    final int idoctor = 4;
    String[] drinkNames = {"tea", "coffee", "milk", "juice", "water"};
    final int itea = 0;
    final int icoffee = 1;
    final int imilk = 2;
    final int ijuice = 3; /* , iwater = 4 */
    ...
    store.impose(
        new Eq(
            new XplusCeqZ(nationality[inorwegian], 1, color[iblue]),
            new Not(new XplusCeqZ(color[iblue], 1, nationality[inorwegian]))));
    ...
    store.impose(
        new Or(
            new XplusCeqZ(pet[ifox], 1, profession[idoctor]),
