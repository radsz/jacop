...
public class MasterClass extends ExampleFd {
  ...
  public void model() {
    ...
    // indexes for ease of referring
    final int iKinsley = 0;
    final int iRobinson1 = 1;
    final int iRobinson2 = 2;
    final int iWalker = 3;
    final int iUrlich = 4;
    ...
    store.impose(
        new Or(
            new Or(new XeqC(zglos[itenor1], 2), new XeqC(zglos[itenor1], 3)),
    ...
    store.impose(
        new Or(
            new Or(
                new XeqY(znazwisko[iKinsley], zglos[itenor1]),
                new XeqY(znazwisko[iKinsley], zglos[itenor2])),
            new XeqY(znazwisko[iKinsley], zglos[isopran])));

    store.impose(
        new Or(
            new Or(new XeqC(zglos[itenor1], 5), new XeqC(zglos[itenor2], 5)),
