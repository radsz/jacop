 ...
 *
 * <p>Each weekday, Bonnie takes care of five of the neighbors' children. The children's names are
 * Keith, Libby, Margo, Nora, and Otto; last names are Fell, Grant, Hall, Ivey, and Jule. Each is a
 * different number of years old, from two to six. Can you find each child's full name and age?
 *
 * <p>1. One child is named Libby Jule. 2. Keith is one year older than the Ivey child, who is one
 * year older than Nora. 3. The Fell child is three years older than Margo. 4. Otto is twice as many
 * years old as the Hall child.
 *
...
public class BabySitting extends ExampleFd {
  ...
  public void model() {
    ...
    log.info("Program to solve Babysitting problem ");

    // arrays with surnames
    String[] surnameNames = {"Fell", "Grant", "Hall", "Ivey", "Jule"};

    final int ifell = 0; /* igrant = 1, */
    final int ihall = 2;
    final int iivey = 3;
    final int ijule = 4;
