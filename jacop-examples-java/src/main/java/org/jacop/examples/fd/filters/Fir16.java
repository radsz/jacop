...
public class Fir16 extends Filter {
  ...
  public Fir16(int addDel, int mulDel) {
    ...
    this.ids =
        new int[] {
          MUL_ID, MUL_ID, MUL_ID, MUL_ID, MUL_ID, MUL_ID, MUL_ID, MUL_ID, MUL_ID, MUL_ID, MUL_ID,
              MUL_ID, MUL_ID,
          MUL_ID, MUL_ID, MUL_ID, MUL_ID, ADD_ID, ADD_ID, ADD_ID, ADD_ID, ADD_ID, ADD_ID, ADD_ID,
              ADD_ID, ADD_ID,
          ADD_ID, ADD_ID, ADD_ID, ADD_ID, ADD_ID, ADD_ID, ADD_ID
        };
