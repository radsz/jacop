...
/**
 * This class executes the provided example. It also allows to specify the arguments for the
 * executed example.
 *
...
public class RunExample {
  ...
  /**
   * It executes the example as specified by the first argument. The remaining arguments will be
   * forwarded to the executed example.
   *
  ...
  public static void main(String[] args) {
    ...
    if (args[args.length - 1].endsWith(".fzn")) {
      ...
      try {
        ...
        Method mainMethod =
            Class.forName("org.jacop.examples." + args[0]).getMethod("main", mainArgs);
        ...
        System.err.println(
            "exampleloader: can't find class \""
                + e.getMessage()
