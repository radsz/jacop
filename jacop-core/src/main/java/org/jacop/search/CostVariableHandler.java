...
/**
 * Handler interface for type-specific cost variable operations in search algorithms. This interface
 * allows search classes to work with different variable types (IntVar, FloatVar, SetVar) without
 ...
 * IntCostVariableHandler in jacop-core - FloatCostVariableHandler in jacop-floats -
...
public interface CostVariableHandler {
  ...
  /**
   * Gets the previous cost value for minimization. For FloatVar, this accounts for floating-point
   * precision. For IntVar, this is simply costValue - 1.
   *
