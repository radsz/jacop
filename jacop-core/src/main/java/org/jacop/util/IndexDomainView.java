...
public class IndexDomainView {
  ...
  /**
   * It marks all values in focus of the index domain view as not supported and requiring support to
   * be established.
   */
  ...
  /**
   * It removes all values for which no support was found since the initialization of the support
   * sweep.
   *
   ...
   *
   * @return number of values in the variable domain for which the index domain view is being
   *     created.
   */
  public int getSize() {
    return var.getSize();
