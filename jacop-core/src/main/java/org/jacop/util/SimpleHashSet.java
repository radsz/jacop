 ...
 * constraints for evaluation. It's implementation was partially based on standard hash set
 * implementation as implemented in java util class.
 *
...
public class SimpleHashSet<E> {
  ...
  /**
   * Constructs an empty {@code HashSet} with the specified initial capacity and the default load
   * factor (0.75).
   *
  ...
  /**
   * Constructs an empty {@code HashSet} with the specified initial capacity and load factor.
   *
   * @param initialCapacity The initial capacity.
  ...
  /**
   * Returns the boolean value which specifies if given element is already in this identity hash
   * set.
   *
  ...
  /**
   * Removes and returns an entry removed from the HashSet. Returns null if the HashSet contains no
   * entry.
   *
  ...
  /**
   * Rehashes the contents of this set into a new array with a larger capacity. This method is
   * called automatically when the number of elements in this set reaches its threshold.
   *
   * <p>If current capacity is MAXIMUM_CAPACITY, this method does not resize the set, but sets
