...
public interface MutableVar extends Stateful {
  ...
  /**
   * It replace the current representation of the value with a new representation. It ignores the
   * store level.
   *
  ...
  /**
   * It updates the value of a mutable variable based on value given as a parameter, the stamp level
   * of current value and stamp value of passed value.
   *
