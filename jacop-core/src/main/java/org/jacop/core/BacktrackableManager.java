...
public interface BacktrackableManager {
   ...
   * function works properly only during model creation phase, so manager can learn about freshly
   * created objects. If used during search then the old array must be part of the new array to
   * allow manager work properly.
   *
