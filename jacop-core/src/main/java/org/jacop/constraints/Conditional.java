...
/**
 * Conditional constraint implements conditional constraint satisfiability. It enforces consistency
 * of constraint c[k] where b[k] = 1 (true) and all b[i] for i {@literal <} k are 0 (false).
 *
