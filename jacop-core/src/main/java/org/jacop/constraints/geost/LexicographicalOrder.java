...
public interface LexicographicalOrder {
   ...
   * @param p1 point 1
   * @param p2 point 2
   * @return comparison result: a negative value if p1 is smaller than p2, 0 if p1 is equal to p2,
   *     and a positive value if p1 is larger than p2.
   */
   ...
   * significant dimension is not changed)
   *
