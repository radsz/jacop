...
public class Rectangle {
    ...
    for (int i = 0; i < rectangles.size(); i++) {
      if (rectangles.get(i).size() == 4) {
        ...
        String s =
            "\nInput list of index "
                + i
                + " is not representing a 2D rectangle since this list size is "
                + rectangles.get(i).size()
                + " instead of 4.";
    ...
    for (int i = 0; i < rectangles.length; i++) {
      ...
      if (rectangles[i].length == 4) {
        ...
        String s =
            "\n Rectangle of index "
                + i
                + " is not a 2D rectangle as a list representing this rectangle is of size "
                + rectangles[i].length
                + "instead of size 4.";
        throw new IllegalArgumentException(s);
      }
   ...
   *
   * @return true if in any dimension the rectangle has minimum possible length equal 0, false
   *     otherwise.
   */
