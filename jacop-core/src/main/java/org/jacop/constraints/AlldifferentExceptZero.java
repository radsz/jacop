...
/**
 * AlldifferentExceptZero constraint assures that all FDVs except
 * those with zero value have differnet values. 
 *
 * @author Krzysztof Kuchcinski and Radoslaw Szymanek
 * @version 4.10
 */

public class AlldifferentExceptZero extends Alldifferent implements UsesQueueVariable, SatisfiedPresent {
