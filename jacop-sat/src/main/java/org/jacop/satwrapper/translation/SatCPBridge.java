...
public abstract class SatCPBridge implements WrapperComponent {
   ...
   * @param isEquality true if we want the literal for '{@code x=d}' kind of propositions, false for
   *     '{@code x<=d}'
   * @return the literal corresponding to 'var = this value'. If the value is out of the domain of
