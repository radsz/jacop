 ...
 *
 * <p>It does not work with watched literals. All literals are watching and if any of them changes
 * then clause is being checked for unit propagation.
 *
...
public final class TernaryClausesDatabase extends AbstractClausesDatabase {
  ...
  /**
   * Adds a ternary clause to the database.
   *
   * @param clause the clause to add (must be of length 3)
