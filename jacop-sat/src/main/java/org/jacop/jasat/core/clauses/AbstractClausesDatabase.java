 ...
 *
 * <p>Those databases must use a MemoryPool to allocate their structures.
 *
 * <p>All ClausesDatabases have access to the DatabasesStore they belong to, so that they can
...
public abstract class AbstractClausesDatabase implements SolverComponent, ClauseDatabaseInterface {
   ...
   * index of the n-th watched clause.
   */
