...
/**
 * MemoryPool for arbitrary types. Less efficient than MemoryPool, but maybe more efficient than
 * allocating. To be used if some data structure is often allocated/deallocated.
 *
