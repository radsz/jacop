...
/**
 * Defines a minimum cardinality, of the least upper bound, variable comparator. The variable with
 * the minimum cardinality for the least upper bound has the priority.
 *
...
public class MinLubCard<T extends SetVar> implements ComparatorVariable<T> {
  ...
  public int compare(T leftVar, T rightVar) {
    ...
    int left = leftSetDom.lub().getSize();
    int right = rightSetDom.lub().getSize();
