...
public abstract class SetDomain extends Domain {
  ...
  /**
   * Adds a set of values to the set of possible values used within this set domain. It changes the
  ...
  /**
   * Adds a set domain to this set domain. This operation may add more sets than intended if for
   * example used in the context of BoundSetDomain which can not represent arbitrary union of two
   * sets.
   *
