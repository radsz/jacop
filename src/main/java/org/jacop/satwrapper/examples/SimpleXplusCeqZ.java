...
public class SimpleXplusCeqZ extends ExampleFD {
	...
	public void model() {
		...
		x1 = new IntVar(store, "x1", 1, 15);
		x2 = new IntVar(store, "x2", 1, 15);
		x3 = new IntVar(store, "x3", 1, 15);
	        IntVar[] list = {x1, x2, x3};
		...
		// sum constraint
		store.impose(new XplusCeqZ(x1, 5, x2));
		store.impose(new XplusCeqZ(x2, 5, x3));
		
                store.impose(new Alldistinct(list));
	...
	public static void main(String args[]) {
		...
		SimpleXplusCeqZ example = new SimpleXplusCeqZ();
