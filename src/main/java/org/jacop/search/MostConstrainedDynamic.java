...
public class MostConstrainedDynamic<T extends Var> implements ComparatorVariable<T> { private static Logger logger = LoggerFactory.getLogger(MostConstrainedDynamic.class);
