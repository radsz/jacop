...
public class SimpleImprovementSearch<T extends IntVar> implements ImproveSolution<T> { private static Logger logger = LoggerFactory.getLogger(SimpleImprovementSearch.class);
     ...
     *
     */
    public class CostListener<T extends IntVar> extends SimpleSolutionListener<T> { private Logger logger = LoggerFactory.getLogger(CostListener.class);
