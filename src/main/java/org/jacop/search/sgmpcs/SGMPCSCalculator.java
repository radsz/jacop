...
public class SGMPCSCalculator<T extends Var> implements ConsistencyListener { private static Logger logger = LoggerFactory.getLogger(SGMPCSCalculator.class);
