...
public class MostConstrainedStatic<T extends Var> implements ComparatorVariable<T> { private static Logger logger = LoggerFactory.getLogger(MostConstrainedStatic.class);
