...
public class IndomainSimpleRandom<T extends IntVar> implements Indomain<T> { private static Logger logger = LoggerFactory.getLogger(IndomainSimpleRandom.class);
