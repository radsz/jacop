...
public class Pruning extends Network {
    ...
    public class PercentStrategy implements PruningStrategy {
        ...
        public void init() {
            ...
            i = 0;
            limit = Math.max(Math.min(minimum, numActiveArcs), (int) Math.round(numActiveArcs * percentage));
    ...
    void pruneNodesWithSmallDegree() {
        ...
        for (Node node : nodes) {
            if (node.degree == 1) {
                ...
                if (companion1 != null && companion1.xVar != null && companion2 != null && companion2.xVar != null) {
