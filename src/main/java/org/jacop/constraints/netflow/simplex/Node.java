...
public final class Node {
    ...
    public String toString() {
        ...
        return "[node: " + name + ", balance=" + balance + ", delta=" + deltaBalance + ", potential=" + potential + ", depth=" + depth
            + ", parent=" + (parent == null ? null : parent.name) + ", thread=" + (thread == null ? null : thread.name) + "]";
    }
}
