    ...
    public static boolean checkFlow(NetworkSimplex g) {
        ...
        for (Node n : g.nodes) {
            ...
            assert (n.balance == out - in) :
                "Balance on node\n" + "out = " + out + ", in = " + in + ", balance = " + n.balance + "\n" + n + "\n";

            assert (n.initialBalance - n.balance - n.deltaBalance == del_out - del_in) :
                "Balance on deleted node\n" + "out = " + del_out + ", in = " + del_in + ", balance = " + n.balance + ", delta = "
                    + n.deltaBalance + ", initial = " + n.initialBalance + "\n" + "  out-in = " + (del_out - del_in)
                    + ", initial-balance-delta = " + (n.initialBalance - n.balance - n.deltaBalance) + "\n" + n + "\n";
        }
