            ...
            while (i < size() && notFound) {
                ...
                if (b <= p.min) {
                    ...
                    if (p.max <= a) {
                        ...
                        ProfileItem new1 = new ProfileItem(type), new2 = new ProfileItem(type), new3 = new ProfileItem(type);
                        p.overlap(new ProfileItem(type, a, b, val), new1, new2, new3);

                        if (trace)
                            System.out.println(
                                "Overlap of " + "[" + a + ".." + b + ")" + "=" + val + " and " + p + "\nResult = " + new1 + ", " + new2
                                    + ", " + new3);
                        ...
                        if (new2.min != -1) {
                            ...
                            if (previous.max == new2.min && previous.value == new2.value) {
                                if (trace)
                                    System.out.println(
                                        "5a. Change " + "[" + previous.min + ".." + new2.max + ")" + "=" + val + " at position " + i);
