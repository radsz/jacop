...
public class GeostObject { private static Logger logger = LoggerFactory.getLogger(GeostObject.class);
	 ...
	 */
	public class TimeBoundConstraint { private Logger logger = LoggerFactory.getLogger(TimeBoundConstraint.class);
