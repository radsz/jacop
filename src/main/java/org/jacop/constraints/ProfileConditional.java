                ...
                if (b <= p.min) {
                    if (a != b) {
                        if (b == p.min && val == p.value) {
                            if (trace)
                                System.out.println("2a. Change " + "[" + a + ".." + p.max + ")" + "=" + val + " at position " + i);
                            // !!!! b==p.Min
                            // p.Min = a;
                            int[] r = {index, val};
                            ...
                            if (i > 0) {
                                ...
                                if (trace)
                                    System.out.println("2b. Add " + "[" + a + ".." + b + ")" + "=" + val + " at position " + i);
                                int[] r = {index, val}; // OK
                                add(i, new ProfileItemCondition(a, b, val, r));
                            }
                        }
                    ...
                    if (p.max <= a) {
                        if (i == size() - 1) {
                            if (a != b) {
                                if (p.max == a && val == p.value) {
                                    if (trace)
                                        System.out.println("3a. Change " + "[" + p.min + ".." + b + ")" + "=" + val + " at position " + i);
                                    // !!! b > p.Min && p.Max == a
                                    // p.Max = b;
                                    int[] r = {index, val}; // OK
                                    add(i + 1, new ProfileItemCondition(a, b, val, r));
                                    ...
                                    // b > p.Max && p.Max < a
                                    if (trace)
                                        System.out.println("3b. Add " + "[" + a + ".." + b + ")" + "=" + val + " at position " + (i + 1));
                                    int[] r = {index, val}; // OK
                                    add(i + 1, new ProfileItemCondition(a, b, val, r));
                                }
                            }
                        ...
                        ProfileItemCondition new1 = new ProfileItemCondition(), new2 = new ProfileItemCondition(), new3 =
                            new ProfileItemCondition();
                        int[] r = {index, val};

                        if (trace)
                            System.out.println("Overlap of " + "[" + a + ".." + b + ")" + "=" + val + ", [" + index + "] " + " and " + p);

                        p.overlap(new ProfileItemCondition(a, b, val, r), new1, new2, new3, exList, r);
                        if (trace)
                            System.out.println("Result = " + new1 + ", " + new2 + ", " + new3);
                        ...
                        if (new1.min != -1) {
                            ...
                            if (previous.max == new1.min && previous.value == new1.value) {
                                if (trace)
                                    System.out.println(
                                        "4a. Change " + "[" + previous.min + ".." + new1.max + ")" + "=" + val + " at position " + i);
                                // !!!
                        ...
                        if (new2.min != -1) {
                            ...
                            if (previous.max == new2.min && previous.value == new2.value) {
                                if (trace)
                                    System.out
                                        .println("5a. Change " + "[" + new2.min + ".." + new2.max + ")" + "=" + val + " at position " + i);
                                // !!!
