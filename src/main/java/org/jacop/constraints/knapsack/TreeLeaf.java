...
public final class TreeLeaf extends TreeNode {
    ...
    @Override final public int getWMax() {
    ...
    @Override final public int getWSum() {
    ...
    @Override final public int getPSum() {
    ...
    @Override public final String nodeToString() {
        return toString();
    }
    ...
    @Override public void recomputeDown(Tree tree) {
        updateInternalValues(tree);
    }

    @Override public void recomputeUp(Tree tree) {
