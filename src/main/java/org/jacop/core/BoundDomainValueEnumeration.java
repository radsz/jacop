...
public class BoundDomainValueEnumeration extends ValueEnumeration { private static Logger logger = LoggerFactory.getLogger(BoundDomainValueEnumeration.class);
