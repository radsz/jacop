...
public class IntervalBasedBacktrackableManager extends SimpleBacktrackableManager {
     ...
     */
    @Override public void removeLevel(int removedLevel) {
            ...
            if (trailContainsAllChanges) {
                ...
                if (intervalBasedTrail.remove(intervalBasedTrail.size() - 1)) {
                    ...
                    while (true) {
                        ...
                        while (currentPositionInHoles < lastTrail.length && lastTrail[currentPositionInHoles] == -1)
                ...
                if (addingToIntervals) {
                    ...
                    while (true) {
                        ...
                        while (currentPositionInHoles < currentIntervals.length && currentIntervals[currentPositionInHoles] == -1)
                            currentPositionInHoles += 2;
     ...
     */
    @Override public boolean isRecognizedAsChanged(int index) {
