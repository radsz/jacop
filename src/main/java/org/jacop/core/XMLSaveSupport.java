...
@SuppressWarnings("unchecked") public class XMLSaveSupport {
                ...
                if (var != null) {
                    ...
                    for (int i = 0; i < var.dom().modelConstraintsToEvaluate.length; i++)
                        for (int j = 0; j < var.dom().modelConstraintsToEvaluate[i]; j++) {
                            Constraint olderConstraint =
                                constraints.put(var.dom().modelConstraints[i][j].id(), var.dom().modelConstraints[i][j]);
                            assert (olderConstraint == null || olderConstraint == var
                                .dom().modelConstraints[i][j]) : "Constraint id(s) are not unique.";
    ...
    @SuppressWarnings("unchecked") public static void save(TransformerHandler handler, Object a, AttributesImpl nestedAtts) {
                ...
                for (int i = 0; i < types.length; i++) {
                    ...
                    if (ithArgument == null) {
                        ...
                        try {
                            ...
                            assert (false) :
                                "xmlAttributes mismatch at " + i + "-th element. No attribute " + names[i] + " found. " + " No function "
                                    + functionName + "() found." + "No function " + names[i] + "() found.";
                        }
                    ...
                    if (types[i].isPrimitive()) {
                        ...
                        if (value == null) {
                            ...
                            try {
                                ...
                                assert (false) : "xmlAttributes mismatch at " + i + "-th element. No attribute " + names[i] + " found. "
                                    + " No function " + functionName + "() found." + "No function " + names[i] + "() found.";
                            }
    ...
    private static String id(Object object)
        throws IllegalArgumentException, SecurityException, IllegalAccessException, NoSuchFieldException, InvocationTargetException {
    ...
    private static void saveArray(TransformerHandler handler, Object object)
        throws IllegalArgumentException, SecurityException, IllegalAccessException, NoSuchFieldException, InvocationTargetException,
        SAXException {
