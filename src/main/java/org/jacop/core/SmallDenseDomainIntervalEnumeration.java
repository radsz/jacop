...
public class SmallDenseDomainIntervalEnumeration extends IntervalEnumeration { private static Logger logger = LoggerFactory.getLogger(SmallDenseDomainIntervalEnumeration.class);
