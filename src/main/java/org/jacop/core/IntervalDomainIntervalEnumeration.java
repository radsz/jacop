...
public class IntervalDomainIntervalEnumeration extends IntervalEnumeration { private static Logger logger = LoggerFactory.getLogger(IntervalDomainIntervalEnumeration.class);
