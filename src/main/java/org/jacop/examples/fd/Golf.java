...
public class Golf extends ExampleFD {
    ...
    @Override public void model() {
        ...
        PrimitiveConstraint[] c1 = {new XplusCeqZ(LN[iSands], 4, FN[iFrank]), new XplusCeqZ(LN[iSands], 7, Jobs[iCaddy])};
        PrimitiveConstraint[] c2 = {new XplusCeqZ(LN[iSands], 7, FN[iFrank]), new XplusCeqZ(LN[iSands], 4, Jobs[iCaddy])};
