...
public class Flowers extends ExampleFD {
    ...
    @Override public void model() {
        ...
        PrimitiveConstraint ogr2[] = {new XeqC(occasionD[iWalentynki], 11), new XeqC(occasionD[iWalentynki], 14)};
        ...
        PrimitiveConstraint ogr4[] =
            {new XplusCeqZ(wifeT[iLynn], 1, flowerT[iViolets]), new XplusCeqZ(wifeT[iLynn], -1, flowerT[iViolets])};
        ...
        PrimitiveConstraint and5a[] =
            {new XeqC(husbandD[iJustin], 7), new XeqC(flowerD[iRoses], 7), new XeqY(husbandD[iJustin], flowerD[iRoses])};

        PrimitiveConstraint and5b[] =
            {new XeqC(husbandD[iJustin], 24), new XeqC(occasionD[iUrodziny], 24), new XeqY(husbandD[iJustin], occasionD[iUrodziny])};
        ...
        PrimitiveConstraint ogr7[] = {new XeqY(wifeD[iToni], husbandD[iShane]), new XeqY(wifeD[iToni], husbandD[iDoug])};
        store.impose(new Or(ogr7));

        // 8. One woman received either chrysanthemums or white roses for
        // her wedding anniversary.
        PrimitiveConstraint ogr8[] = {new XeqY(occasionD[iRocznica], flowerD[iChrys]), new XeqY(occasionD[iRocznica], flowerD[iRoses])};
        ...
        PrimitiveConstraint and9a[] =
            {new XeqC(wifeD[iKristin], 1), new XeqC(flowerD[iDaises], 1), new XeqY(wifeD[iKristin], flowerD[iDaises])};

        PrimitiveConstraint and9b[] =
            {new XeqC(wifeD[iKristin], 18), new XeqC(husbandD[iDoug], 18), new XeqY(wifeD[iKristin], husbandD[iDoug])};
