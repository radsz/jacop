...
public class FurnitureMoving extends ExampleFD { private static Logger logger = LoggerFactory.getLogger(FurnitureMoving.class);
    ...
    public boolean searchSpecific() {
        ...
        for(int i = 0; i < variables.length; i++) {
            logger.info("Variable " + i + " " + variables[i]);
        }
        ...
        if(result) {
            ...
            logger.info("Piano: " + starts[0].value() + " .. " + endTimes[0].value() + "\n" +
