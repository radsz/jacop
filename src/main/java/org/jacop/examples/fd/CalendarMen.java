...
public class CalendarMen extends ExampleFD {
    ...
    @Override public void model() {
        ...
        String[] firstNames =
            {"Antonio", "Brett", "Cliff", "Dabney", "Ed", "Francisco", "Griff", "Harry", "Ivor", "John", "Karl", "Lorenzo"};

        // indexes for people involved for ease of referring later.
        int iAntonio = 0, iBrett = 1, /* iCliff = 2, */ iDabney = 3, iEd = 4, iFrancisco = 5, iGriff = 6, iHarry = 7, iIvor = 8, iJohn = 9,
            iKarl = 10, iLorenzo = 11;

        // Lastnames of people involved

        String[] lastNames =
            {"Moross", "Nelsen", "O_Rourke", "Paulos", "Quarello", "Reede", "Sheldon", "Taylor", "Uhler", "Vickers", "Wang", "Xiao"};

        // indexes for people involved for ease of referring later.
        int iMoross = 0, iNelsen = 1, iO_Rourke = 2, iPaulos = 3, iQuarello = 4, iReede = 5, iSheldon = 6, iTaylor = 7, iUhler = 8, /* iVickers = 9, */
            iWang = 10, iXiao = 11;

        // Names of sports

        String[] sportNames =
            {"archery", "badminton", "croquet", "football", "golf", "hockey", "lacrosse", "vaulting", "rowing", "squash", "tennis",
                "volleyball"};

        // indexes for sports involved for ease of referring later.
        int iarchery = 0, ibadminton = 1, icroquet = 2, ifootball = 3, igolf = 4, ihockey = 5, ilacrosse = 6, ivaulting = 7, irowing = 8,
            isquash = 9, itennis = 10, ivolleyball = 11;
    ...
    public void modelBasic() {
        ...
        String[] firstnameID =
            {"Antonio", "Brett", "Cliff", "Dabney", "Ed", "Francisco", "Griff", "Harry", "Ivor", "John", "Karl", "Lorentzo"};

        int iAntonio = 0, iBrett = 1, /* iCliff = 2, */ iDabney = 3, iEd = 4, iFrancisco = 5, iGriff = 6, iHarry = 7, iIvor = 8, iJohn = 9,
            iKarl = 10, iLorentzo = 11;

        String[] surnameID =
            {"Moross", "Nelsen", "ORourke", "Paulos", "Quarello", "Reede", "Sheldon", "Taylor", "Uhler", "Vickers", "Wang", "Xiao"};

        int iMoross = 0, iNelsen = 1, iORourke = 2, iPaulos = 3, iQuarello = 4, iReede = 5, iSheldon = 6, iTaylor = 7, iUhler = 8, /* iVickers = 9, */
            iWang = 10, iXiao = 11;

        String[] sportID =
            {"archery", "badmington", "croquet", "football", "golf", "hockey", "lacrosse", "p_vauliting", "rowing", "squash", "tennis",
                "volleyball"};

        int iarchery = 0, ibadmington = 1, icroquet = 2, ifootball = 3, igolf = 4, ihockey = 5, ilacrosse = 6, ip_vauliting = 7, irowing =
            8, isquash = 9, itennis = 10, ivolleyball = 11;
        ...
        PrimitiveConstraint[] v11 =
            {new XeqC(firstname[iFrancisco], 4), new XeqC(firstname[iFrancisco], 7), new XeqC(firstname[iFrancisco], 10)};

        PrimitiveConstraint[] v12 = {new XeqC(surname[iSheldon], 4), new XeqC(surname[iSheldon], 7), new XeqC(surname[iSheldon], 10)};

        PrimitiveConstraint[] v13 = {new XeqC(sport[ivolleyball], 4), new XeqC(sport[ivolleyball], 7), new XeqC(sport[ivolleyball], 10)};
        ...
        PrimitiveConstraint[] v24 =
            {new XplusCeqZ(firstname[iKarl], 1, surname[iMoross]), new XplusCeqZ(surname[iMoross], 1, sport[ihockey])};

        PrimitiveConstraint[] v25 =
            {new XplusCeqZ(firstname[iKarl], 1, sport[ihockey]), new XplusCeqZ(sport[ihockey], 1, surname[iMoross])};

        PrimitiveConstraint[] v26 =
            {new XplusCeqZ(surname[iMoross], 1, firstname[iKarl]), new XplusCeqZ(firstname[iKarl], 1, sport[ihockey])};

        PrimitiveConstraint[] v27 =
            {new XplusCeqZ(surname[iMoross], 1, sport[ihockey]), new XplusCeqZ(sport[ihockey], 1, firstname[iKarl])};

        PrimitiveConstraint[] v28 =
            {new XplusCeqZ(sport[ihockey], 1, surname[iMoross]), new XplusCeqZ(surname[iMoross], 1, firstname[iKarl])};

        PrimitiveConstraint[] v29 =
            {new XplusCeqZ(sport[ihockey], 1, firstname[iKarl]), new XplusCeqZ(firstname[iKarl], 1, surname[iMoross])};

        PrimitiveConstraint[] v23 = {new And(v24), new And(v25), new And(v26), new And(v27), new And(v28), new And(v29)};
        ...
        PrimitiveConstraint[] v41 = {new XeqC(firstname[iIvor], 6), new XeqC(firstname[iIvor], 9), new XeqC(firstname[iIvor], 12)};

        PrimitiveConstraint[] v42 = {new XeqC(surname[iORourke], 6), new XeqC(surname[iORourke], 9), new XeqC(surname[iORourke], 12)};

        PrimitiveConstraint[] v43 = {new XeqC(sport[itennis], 6), new XeqC(sport[itennis], 9), new XeqC(sport[itennis], 12)};
        ...
        PrimitiveConstraint[] v91 = {new XeqC(firstname[iGriff], 1), new XeqC(firstname[iGriff], 5), new XeqC(firstname[iGriff], 9)};

        PrimitiveConstraint[] v92 = {new XeqC(surname[iReede], 1), new XeqC(surname[iReede], 5), new XeqC(surname[iReede], 9)};

        PrimitiveConstraint[] v93 = {new XeqC(sport[iarchery], 1), new XeqC(sport[iarchery], 5), new XeqC(sport[iarchery], 9)};
        ...
        PrimitiveConstraint[] v100 =
            {new XplusCeqZ(firstname[iBrett], 1, firstname[iEd]), new XplusCeqZ(firstname[iEd], 1, firstname[iLorentzo])};

        PrimitiveConstraint[] v101 =
            {new XplusCeqZ(firstname[iBrett], 1, firstname[iLorentzo]), new XplusCeqZ(firstname[iLorentzo], 1, firstname[iEd])};

        PrimitiveConstraint[] v102 =
            {new XplusCeqZ(firstname[iEd], 1, firstname[iBrett]), new XplusCeqZ(firstname[iBrett], 1, firstname[iLorentzo])};

        PrimitiveConstraint[] v103 =
            {new XplusCeqZ(firstname[iEd], 1, firstname[iLorentzo]), new XplusCeqZ(firstname[iLorentzo], 1, firstname[iBrett])};

        PrimitiveConstraint[] v104 =
            {new XplusCeqZ(firstname[iLorentzo], 1, firstname[iEd]), new XplusCeqZ(firstname[iEd], 1, firstname[iBrett])};

        PrimitiveConstraint[] v105 =
            {new XplusCeqZ(firstname[iLorentzo], 1, firstname[iBrett]), new XplusCeqZ(firstname[iBrett], 1, firstname[iEd])};

        PrimitiveConstraint[] v106 = {new And(v100), new And(v101), new And(v102), new And(v103), new And(v104), new And(v105)};
        ...
        PrimitiveConstraint[] v111 =
            {new XplusCeqZ(firstname[iEd], 1, surname[iUhler]), new XplusCeqZ(surname[iUhler], 1, sport[icroquet])};

        PrimitiveConstraint[] v112 =
            {new XplusCeqZ(firstname[iEd], 1, sport[icroquet]), new XplusCeqZ(sport[icroquet], 1, surname[iUhler])};

        PrimitiveConstraint[] v113 = {new XplusCeqZ(surname[iUhler], 1, firstname[iEd]), new XplusCeqZ(firstname[iEd], 1, sport[icroquet])};

        PrimitiveConstraint[] v114 =
            {new XplusCeqZ(surname[iUhler], 1, sport[icroquet]), new XplusCeqZ(sport[icroquet], 1, firstname[iEd])};

        PrimitiveConstraint[] v115 =
            {new XplusCeqZ(sport[icroquet], 1, surname[iUhler]), new XplusCeqZ(surname[iUhler], 1, firstname[iEd])};

        PrimitiveConstraint[] v116 = {new XplusCeqZ(sport[icroquet], 1, firstname[iEd]), new XplusCeqZ(firstname[iEd], 1, surname[iUhler])};

        PrimitiveConstraint[] v110 = {new And(v111), new And(v112), new And(v113), new And(v114), new And(v115), new And(v116)};
        ...
        PrimitiveConstraint[] v121 = {new XeqC(firstname[iDabney], 4), new XeqC(firstname[iDabney], 6), new XeqC(firstname[iDabney], 8)};

        PrimitiveConstraint[] v122 = {new XeqC(surname[iNelsen], 4), new XeqC(surname[iNelsen], 6), new XeqC(surname[iNelsen], 8)};

        PrimitiveConstraint[] v123 = {new XeqC(sport[ilacrosse], 4), new XeqC(sport[ilacrosse], 6), new XeqC(sport[ilacrosse], 8)};
