...
public class MasterClass extends ExampleFD {
    ...
    @Override public void model() {
        ...
        store.impose(new Or(new Or(new XeqC(zglos[itenor1], 2), new XeqC(zglos[itenor1], 3)),
            new Or(new XeqC(zglos[itenor2], 2), new XeqC(zglos[itenor2], 3))));
        ...
        store.impose(new Or(new Or(new XeqY(znazwisko[iKinsley], zglos[itenor1]), new XeqY(znazwisko[iKinsley], zglos[itenor2])),
            new XeqY(znazwisko[iKinsley], zglos[isopran])));

        store.impose(new Or(new Or(new XeqC(zglos[itenor1], 5), new XeqC(zglos[itenor2], 5)), new XeqC(zglos[isopran], 5)));
        ...
        store.impose(new Or(new XeqC(znazwisko[iRobinson1], 3), new XeqC(znazwisko[iRobinson2], 3)));
