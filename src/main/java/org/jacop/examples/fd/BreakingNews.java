...
public class BreakingNews extends ExampleFD {
    ...
    @Override public void model() {
        ...
        // 1. The 30-pound baby wasn't born in South Amboy or New Hope.
        store.impose(new Or(new XneqY(story[i30pound], location[iNewHope]), new XneqY(story[i30pound], location[iSouthAmboy])));
        ...
        store.impose(new Or(new And(new XeqY(story[iblimp], reporter[iLous]), new XeqY(story[iskyscraper], location[iPortCharles])),
            new And(new XeqY(story[iblimp], location[iPortCharles]), new XeqY(story[iskyscraper], reporter[iLous]))));

        // 4. South Amboy was not the site of either the beached whale
        // or the skyscraper dedication.
        store.impose(new Or(new XneqY(location[iSouthAmboy], story[ibeached]), new XneqY(location[iSouthAmboy], story[iskyscraper])));
        ...
        orConstraint[2] = new And(new XeqY(story[ibeached], reporter[iCorey]), new XeqY(reporter[iCorey], (location[iBayonne])));
