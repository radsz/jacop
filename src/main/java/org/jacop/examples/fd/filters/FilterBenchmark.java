...
public class FilterBenchmark {
    ...
    public static void experiment1(Store store, Filter filter, int addNum, int mulNum) {
        ...
        SelectChoicePoint<IntVar> select =
            new SimpleMatrixSelect<IntVar>(vars, new SmallestMin<IntVar>(), new MostConstrainedStatic<IntVar>(), new IndomainMin<IntVar>(),
                0);
    ...
    public static void experiment1PM(Store store, Filter filter, int addNum, int mulNum) {
        ...
        SelectChoicePoint<IntVar> select =
            new SimpleMatrixSelect<IntVar>(vars, new SmallestMax<IntVar>(), new MostConstrainedStatic<IntVar>(), new IndomainMin<IntVar>(),
                0);
    ...
    public static void experiment2PM(Store store, Filter filter, int addNum, int mulNum) {
        ...
        SelectChoicePoint<IntVar> selectMC =
            new SimpleSelect<IntVar>(varsTs, new MostConstrainedStatic<IntVar>(), new SmallestDomain<IntVar>(), new IndomainMin<IntVar>());
        SelectChoicePoint<IntVar> selectIO = new SimpleSelect<IntVar>(varsRs, null, null, new IndomainMin<IntVar>());
    ...
    public static void experiment2P(Store store, Filter filter, int addNum, int mulNum) {
        ...
        SelectChoicePoint<IntVar> selectMC =
            new SimpleSelect<IntVar>(varsTs, new SmallestMin<IntVar>(), new MostConstrainedStatic<IntVar>(), new IndomainMin<IntVar>());
        SelectChoicePoint<IntVar> selectIO = new SimpleSelect<IntVar>(varsRs, null, null, new IndomainMin<IntVar>());
