...
public class Zebra extends ExampleFD {
    ...
    @Override public void model() {
        ...
        store.impose(new Eq(new XplusCeqZ(nationality[inorwegian], 1, color[iblue]),
        ...
        store.impose(new Or(new XplusCeqZ(pet[ifox], 1, profession[idoctor]), new XplusCeqZ(profession[idoctor], 1, pet[ifox])));
