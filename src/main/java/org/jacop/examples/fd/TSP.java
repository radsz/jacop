...
public class TSP extends ExampleFD {
    ...
    @Override public void model() {
        ...
        int[][] distance = {{1000, 85, 110, 94, 71, 76, 25, 56, 94, 67}, {85, 1000, 26, 70, 62, 60, 63, 62, 70, 49},
            {110, 26, 1000, 71, 87, 89, 88, 87, 93, 73}, {94, 70, 71, 1000, 121, 19, 82, 106, 124, 105},
            {71, 62, 87, 121, 1000, 104, 53, 24, 8, 13}, {76, 60, 89, 19, 104, 1000, 65, 89, 108, 93},
            {25, 63, 88, 82, 53, 65, 1000, 30, 57, 46}, {56, 62, 87, 106, 24, 89, 30, 1000, 23, 20},
            {94, 70, 93, 124, 8, 108, 57, 23, 1000, 20}, {67, 49, 73, 105, 13, 93, 46, 20, 20, 1000}};
