...
public class DonaldGeraldRobert extends ExampleFD { private static Logger logger = LoggerFactory.getLogger(DonaldGeraldRobert.class);

	@Override
	public void model() {

		logger.info("Program to solve Donald+Gerald=Robert problem ");
