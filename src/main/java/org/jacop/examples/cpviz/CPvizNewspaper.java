...
public class CPvizNewspaper { private static Logger logger = LoggerFactory.getLogger(CPvizNewspaper.class);
...
// 	public static boolean label() {
	    ...
	    SelectChoicePoint<IntVar> varSelect = new SimpleSelect<IntVar>(vars.toArray(new IntVar[1]), new SmallestMax<IntVar>(),
