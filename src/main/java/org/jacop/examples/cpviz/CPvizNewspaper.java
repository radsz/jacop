...
public class CPvizNewspaper {
    ...
    public void model() {
        ...
        for (int i = 0; i < 3; i++)
            store
                .impose(new XplusYlteqZ(algy[algyPrecedence[i] - 1], durations[algyPrecedence[i] - 1][0], algy[algyPrecedence[i + 1] - 1]));
        ...
        for (int i = 0; i < 3; i++)
            store.impose(new XplusYlteqZ(bertie[bertiePrecedence[i] - 1], durations[bertiePrecedence[i] - 1][1],
        ...
        for (int i = 0; i < 3; i++)
            store.impose(new XplusYlteqZ(charlie[charliePrecedence[i] - 1], durations[charliePrecedence[i] - 1][2],
        ...
        for (int i = 0; i < 3; i++)
            store.impose(
                new XplusYlteqZ(digby[digbyPrecedence[i] - 1], durations[digbyPrecedence[i] - 1][3], digby[digbyPrecedence[i + 1] - 1]));
        ...
        SelectChoicePoint<IntVar> varSelect =
            new SimpleSelect<IntVar>(vars.toArray(new IntVar[1]), new SmallestMax<IntVar>(), new IndomainMin<IntVar>());
