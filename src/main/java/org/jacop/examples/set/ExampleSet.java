...
public abstract class ExampleSet {
    ...
    public boolean search() {
        ...
        SelectChoicePoint<SetVar> select = new SimpleSelect<SetVar>(vars.toArray(new SetVar[1]), null, new IndomainSetMin<SetVar>());
    ...
    public boolean searchSmallestDomain(boolean optimal) {
        ...
        SelectChoicePoint<SetVar> select =
            new SimpleSelect<SetVar>(vars.toArray(new SetVar[1]), new SmallestDomain<SetVar>(), new IndomainSetMin<SetVar>());
    ...
    public boolean searchMostConstrainedStatic() {
        ...
        SelectChoicePoint<SetVar> select =
            new SimpleSelect<SetVar>(vars.toArray(new SetVar[1]), new MostConstrainedStatic<SetVar>(), new IndomainSetMin<SetVar>());
    ...
    public boolean searchMasterSlave(List<Var> masterVars, List<Var> slaveVars) {
        ...
        SelectChoicePoint<SetVar> selectSlave =
            new SimpleSelect<SetVar>(slaveVars.toArray(new SetVar[0]), null, new IndomainSetMin<SetVar>());
        ...
        SelectChoicePoint<SetVar> selectMaster =
            new SimpleSelect<SetVar>(masterVars.toArray(new SetVar[0]), null, new IndomainSetMin<SetVar>());
