...
public abstract class SetDomain extends Domain {
    ...
    public int noConstraints() {
        return searchConstraintsToEvaluate + modelConstraintsToEvaluate[GROUND] + modelConstraintsToEvaluate[LUB]
            + modelConstraintsToEvaluate[GLB] + modelConstraintsToEvaluate[ANY];
    }
