...
public class BoundSetDomain extends SetDomain implements Cloneable {
    ...
    @Override public void inValue(int level, SetVar var, IntDomain set) {
    ...
    @Override public void inLUB(int level, SetVar var, IntDomain intersect) {
    ...
    @Override public void inGLB(int level, SetVar var, IntDomain intersect) {
    ...
    @Override public void addDom(Interval i) {
    ...
    @Override public void inCardinality(int level, SetVar var, int min, int max) {
