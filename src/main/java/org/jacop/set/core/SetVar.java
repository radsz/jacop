...
public class SetVar extends Var {
    ...
    public void domainHasChanged(int event) {
        ...
        assert ((event == SetDomain.LUB && !singleton()) || (event == SetDomain.GLB && !singleton()) || (event == SetDomain.ANY
            && !singleton()) || (event == SetDomain.BOUND && !singleton()) || (event == SetDomain.CARDINALITY && !singleton()) || (
