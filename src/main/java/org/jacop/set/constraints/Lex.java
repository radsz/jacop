                    ...
                    if (nextElinLUBofA == nextElinGLBofB) {
                        ...
                        if (!enumerGLBofB.hasMoreElements())
                            if (enumerLUBofA.hasMoreElements()) {
                                ...
                                if ((strict && nextElinLUBofA < b.domain.lub().max()) || (!strict && nextElinLUBofA <= b.domain.lub()
                                    .max())) {
            ...
            if (b.domain.glb().isEmpty()) {
                ...
                while (true) {
                    ...
                    if (nextElinGLBofA < nextElinGLBofB) {
                        ...
                        // check.
                        if (strict && b.domain.card().min() + 1 == b.domain.card().max() && a.domain.card().max() == 2
                            && a.domain.card().min() == b.domain.card().max() && a.domain.glb().eq(b.domain.lub()))
                    ...
                    if (nextElinGLBofA == nextElinGLBofB) {
                        ...
                        if (!enumerGLBofB.hasMoreElements()) {
                            ...
                            if (noSmaller == 0) {
                                ...
                                if ((b.domain.lub().max() <= nextElinLUBofA && strict) || (b.domain.lub().max() < nextElinLUBofA
                                    && !strict)) {
