...
public class FloatIntervalDomain extends FloatDomain implements Cloneable {
    ...
    @Override public void unionAdapt(FloatInterval i) {
    ...
    @Override public void addDom(FloatDomain domain) {
    ...
    @Override public void unionAdapt(double min, double max) {
        ...
        if (size == 0) {
            ...
            for (; i < size; i++) {
                ...
                if ((next(max) >= intervals[i].min && max <= next(intervals[i].max)) || (next(min) >= intervals[i].min && min <= next(
                    intervals[i].max)) || (min <= intervals[i].min && intervals[i].max <= max))
                    break;
    ...
    @Override public boolean isIntersecting(FloatDomain domain) {
    ...
    @Override public boolean isIntersecting(double min, double max) {
    ...
    @Override public FloatIntervalDomain clone() {
    ...
    @Override public boolean contains(FloatDomain domain) {
    ...
    @Override public FloatDomain complement() {
     ...
     */
    @Override public boolean eq(FloatDomain domain) {
     ...
     */
    @Override public FloatDomain intersect(FloatDomain domain) {
    ...
    @Override public FloatDomain intersect(double min, double max) {
    ...
    @Override public FloatDomain subtract(double value) {
    ...
    */
    ...
    @Override public void setDomain(FloatDomain domain) {
     ...
     */
    @Override public void setDomain(double min, double max) {
        size = 1;
        intervals[0] = new FloatInterval(min, max);
    }
     ...
     */
    @Override public boolean singleton(double c) {
        assert checkInvariants() == null : checkInvariants();
    ...
    @Override public FloatDomain subtract(FloatDomain domain) {
     ...
     */
    @Override public FloatIntervalDomain subtract(double min, double max) {
     ...
     */
    @Override public FloatDomain union(FloatDomain domain) {
        ...
        while (true) {
            ...
            if (i1 == max1) {
                ...
                if (currentDomain1.max <= currentDomain2.max && next(currentDomain1.max) >= currentDomain2.min) {
     ...
     */
    @Override public FloatDomain union(double min, double max) {
    ...
    @Override public FloatDomain union(double value) {
     ...
     */
    @Override public void inMin(int storeLevel, Var var, double min) {
    ...
    @Override public void inMax(int storeLevel, Var var, double max) {
     ...
     */
    @Override public void in(int storeLevel, Var var, double min, double max) {
     ...
     */
    @Override public void in(int storeLevel, Var var, FloatDomain domain) {
        ...
        while (intervals[pointer1].min >= inputIntervals[pointer2].min && intervals[pointer1].max <= inputIntervals[pointer2].max
            && ++pointer1 < size) {
    ...
    @Override public FloatInterval getInterval(int position) {
     ...
     * variable of a change if it occurred.
     */
    @Override public void inComplement(int storeLevel, Var var, double complement) {
    ...
    @Override public void inComplement(int storeLevel, Var var, double min, double max) {
     ...
     */
    @Override public void inShift(int storeLevel, Var var, FloatDomain domain, double shift) {
        ...
        while (intervals[pointer1].min >= inputIntervals[pointer2].min + shift
            && intervals[pointer1].max <= inputIntervals[pointer2].max + shift && ++pointer1 < size) {

            while (intervals[pointer1].max > inputIntervals[pointer2].max + shift && ++pointer2 < input.size)
                ;
            ...
            if (interval1Max < interval2Min) {
                ...
                if (interval1Min <= interval2Min) {
                    ...
                    if (interval1Max <= interval2Max) {
                        ...
                        result.unionAdapt(new FloatInterval(inputIntervals[pointer2].min + shift, inputIntervals[pointer2].max + shift));
     ...
     */
    @Override public double leftElement(int intervalNo) {
     ...
     * It returns the left most element of the given interval.
     */
    @Override public double rightElement(int intervalNo) {
    ...
    @Override public FloatDomain recentDomainPruning(int storeLevel) {
    ...
    @Override public void unionAdapt(double value) {
        unionAdapt(value, value);
    }

    @Override public void subtractAdapt(double value) {
    ...
    @Override public void subtractAdapt(double minValue, double maxValue) {
    ...
    @Override public int intersectAdapt(FloatDomain domain) {
    ...
    @Override public int unionAdapt(FloatDomain union) {
    ...
    @Override public int intersectAdapt(int min, int max) {
    ...
    @Override public int sizeOfIntersection(FloatDomain domain) {
    ...
    @Override public boolean contains(double min, double max) {
