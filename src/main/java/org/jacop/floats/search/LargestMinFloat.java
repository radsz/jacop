...
public class LargestMinFloat<T extends FloatVar> implements ComparatorVariable<T> { private static Logger logger = LoggerFactory.getLogger(LargestMinFloat.class);
