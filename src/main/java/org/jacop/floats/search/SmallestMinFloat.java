...
public class SmallestMinFloat<T extends FloatVar> implements ComparatorVariable<T> { private static Logger logger = LoggerFactory.getLogger(SmallestMinFloat.class);
