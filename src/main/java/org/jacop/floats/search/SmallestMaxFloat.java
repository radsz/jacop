...
public class SmallestMaxFloat<T extends FloatVar> implements ComparatorVariable<T> { private static Logger logger = LoggerFactory.getLogger(SmallestMaxFloat.class);
