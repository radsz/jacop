...
public class TanPeqR extends Constraint { private static Logger logger = LoggerFactory.getLogger(TanPeqR.class);
	...
	do {
		...
		// logger.info ("Normalized interval within -PI..PI interval = " + min + ".." + max);
	    }

	    // logger.info ("Normalized min/max = " + min+".."+max);
	    ...
	    // logger.info ("min in interval " + intervalForMin + ", max in interval " + intervalForMax);
	    ...
	    // logger.info ("atan result " + p + " in " + pMin +".." + pMax + " copied to  n times -PI/2 .. PI/2");
