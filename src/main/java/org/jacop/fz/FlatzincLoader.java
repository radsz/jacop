...
public class FlatzincLoader { private static Logger logger = LoggerFactory.getLogger(FlatzincLoader.class);
	...
	if (opt.getVerbose())
	    logger.info("%% Flatzinc2JaCoP: compiling and executing " + opt.getFileName());
	...
	try {
	    ...
	    parser.model();
            ...
            logger.info("=====UNSATISFIABLE=====",e); // "*** Evaluation of model resulted in fail.");
