...
public class Config extends Properties {
	 ...
	 */
	public ArrayList<SolverComponent> mainComponents =
		new ArrayList<SolverComponent>();
	
	/**
	 * the list of databases the solver must add
	 */
	public ArrayList<AbstractClausesDatabase> clausesDatabases =
		new ArrayList<AbstractClausesDatabase>();
