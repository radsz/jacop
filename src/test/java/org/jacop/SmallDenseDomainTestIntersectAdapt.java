...
public class SmallDenseDomainTestIntersectAdapt {

    private Method prepareMethod;

    public SmallDenseDomainTestIntersectAdapt(String prepareMethodName) throws NoSuchMethodException {
        Class<SmallDenseDomainTestIntersectAdapt> cls = (Class<SmallDenseDomainTestIntersectAdapt>) this.getClass();
