...
public class SmallDenseDomainTestComplement {

    private Method prepareMethod;

    public SmallDenseDomainTestComplement(String prepareMethodName) throws NoSuchMethodException {
        Class<SmallDenseDomainTestComplement> cls = (Class<SmallDenseDomainTestComplement>) this.getClass();
...
//**********************************************************************************************************************
        ...
        IntDomain smallDomain = (IntDomain) prepareMethod.invoke(this, new Object[]{new int[]{1,3, 5,7, 12,18}});
