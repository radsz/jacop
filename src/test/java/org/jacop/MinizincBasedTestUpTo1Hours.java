...
/**
 * Minizinc based tests for problems that run upTo1hour and do not belong
...
@RunWith(Parameterized.class) public class MinizincBasedTestUpTo1Hours extends MinizincBasedTestsHelper {
    ...
    @Rule public Timeout globalTimeout = Timeout.seconds(5400);  //The test will be completed within 90 minutes
