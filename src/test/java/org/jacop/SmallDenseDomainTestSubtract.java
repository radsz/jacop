...
public class SmallDenseDomainTestSubtract {

    private Method prepareMethod;

    public SmallDenseDomainTestSubtract(String prepareMethodName) throws NoSuchMethodException {
        Class<SmallDenseDomainTestSubtract> cls = (Class<SmallDenseDomainTestSubtract>) this.getClass();
