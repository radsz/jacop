...
public class MinizincBasedTestAbove1Hours {
    ...
    public MinizincBasedTestAbove1Hours(List<String> inputString) {
    ...
    public static Collection parametricTest() throws IOException {
        ...
        FileReader file = new FileReader("src/test/fz/above1hour/list.txt");
