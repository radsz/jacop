...
This document identifies all circular dependencies between `jacop-core`, `jacop-floats`, and `jacop-sets` modules that
must be resolved before the multi-module migration can succeed.
